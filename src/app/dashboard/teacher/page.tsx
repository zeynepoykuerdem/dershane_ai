...
import CalendarComponent from "@/app/dashboard/teacher/calendar/page"
            ...
            <div className="bg-white rounded-xl border p-4">
              ...
              <div className="flex flex-col gap-3">
                <div className="bg-purple-50 rounded-lg p-3">
                  <a href="#" className="text-xs text-gray-500">Ödev Yükleme</a>
                </div>
                <div className="bg-blue-50 rounded-lg p-3">
                  <a href="#" className="text-xs text-gray-500">Sınav Oluştur</a>
                </div>
