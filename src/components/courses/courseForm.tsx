    ...
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
      ...
      <Card className="border border-gray-200 shadow-sm">
        <CardContent className="p-6">
          ...
          {/** Baslangic Saati */}
          <div className="space-y-1.5 sm:col-span-2">
            <Label className="text-xs font-medium text-gray-600">Başlangıç Saati</Label>
            <Input
              type="time"
          ...
          {/** Bitiş Saati */}
          <div className="space-y-1.5 sm:col-span-2">
            <Label className="text-xs font-medium text-gray-600">Bitiş Saati</Label>
            <Input
              type="time"
          ...
          <div className="mt-5 flex justify-end">
            ...
            >
              {isSubmitting ? 'Kaydediliyor...' : editId ? 'Güncelle' : 'Dersi Kaydet'}
            </Button>
          </div>
        </CardContent>
      </Card>
            ...
            {courses.map((course) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  {course.course_date && course.start_hour && course.end_hour && (
